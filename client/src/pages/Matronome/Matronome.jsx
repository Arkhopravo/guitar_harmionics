...
import './matronome.scss'
// import Search from "../../components/Search/Search";
import Search from '../Matronome/Search/Search'
import AudiotrackIcon from '@mui/icons-material/Audiotrack';
// import click_1 from "./1_matronome.wav";
...
class Matronome extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      // metronome
    ...
    return (
      <div className="metronome">
        <div className="bpm">
          ...
          <div>
            <span className={calculating ? "activeBPM" : null}
         ...
         <RemoveIcon  className='plusMinus' onClick={() => this.plusMinus(-1)} />
            ...
            <AddIcon className="plusMinus"  onClick={() => this.plusMinus(1)}  />
          </div>
